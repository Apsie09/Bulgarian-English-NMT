...
- All models and components (Transformer, CNN, LSTM, attention, BPE tokenizer, beam search) were implemented from scratch in PyTorch, in accordance with the requirements in `documentation/proj.pdf` (no third‑party ML/NMT libraries beyond the course environment).
